...
After training the model, the accuracy is described below. The accuracy on the training data is high (99.5%). However, even with 10-fold cross validation, the out-of-sample error rate is likely higher than 0.5% since random forests tends to overfit the training data.
